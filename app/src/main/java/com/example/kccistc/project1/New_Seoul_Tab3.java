...
public class New_Seoul_Tab3 extends Fragment {
    ...
    public static New_Seoul_Tab3 newInstance(){
        Bundle args = new Bundle();
        New_Seoul_Tab3 fragmant = new New_Seoul_Tab3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.new_seoul_tab3, container, false);
        ...
        mListView= view.findViewById(R.id.new_list_view3);
        mAdapter =  new New_Seoul_ListView_Adapter(getActivity(), R.layout.new_seoul_list_view_adapter, items);
        mListView.setAdapter(mAdapter);
        mAdapter.notifyDataSetChanged();
        return view;
       // return inflater.inflate(R.layout.new_seoul_tab3, container, false);
    }
