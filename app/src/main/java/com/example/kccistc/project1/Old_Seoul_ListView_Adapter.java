...
public class Old_Seoul_ListView_Adapter extends BaseAdapter {
    ...
    public Old_Seoul_ListView_Adapter(Context context, int layout, ArrayList<Old_Seoul_Item> items){
