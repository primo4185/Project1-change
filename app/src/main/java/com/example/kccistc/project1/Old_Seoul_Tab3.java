 ...
 */
public class Old_Seoul_Tab3 extends Fragment {
    private ArrayList<Old_Seoul_Item> items;
    private ListView mListView;;
    private Old_Seoul_ListView_Adapter mAdapter;
    public static Old_Seoul_Tab3 newInstance(){
        Bundle args = new Bundle();
        Old_Seoul_Tab3 fragmant = new Old_Seoul_Tab3();
        fragmant.setArguments(args);
        return  fragmant;
    }

    public Old_Seoul_Tab3() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.old_seoul_tab3, container, false);
        ...
        mListView= view.findViewById(R.id.old_list_view3);
        mAdapter =  new Old_Seoul_ListView_Adapter(getActivity(), R.layout.old_seoul_list_view_adapter, items);
        mListView.setAdapter(mAdapter);
        mAdapter.notifyDataSetChanged();
        return view;
        //return inflater.inflate(R.layout.old_seoul_tab3, container, false);
    }
